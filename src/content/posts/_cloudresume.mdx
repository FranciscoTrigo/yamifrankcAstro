...
import embededresume from '../../assets/images/embededresume.png';
...
<Image src={embededresume} alt="Quick look at what the resume looks like at the moment" style={{ width: 'auto', height: 'auto' }}  />
